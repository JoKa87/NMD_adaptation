...
def main():
    ...
    data = [
            ...
            "paths"         : [r"C:\Programming\Translational_genomics\NMD_analysis\data\teran_reduced_avg_tcga_info_changed.txt",
                               r"C:\Programming\Translational_genomics\NMD_analysis\data\ptc_variants_sums_hg19_filter8_gt_filtered_filtered_reduced_avg_changed.txt"],
            "separators"    : [",", ","],
            "type"          : "step_histogram"
            },
            {
            ...
            "paths"         : [r"C:\Programming\Translational_genomics\NMD_analysis\data\teran_block_correlation.txt"],
            "separators"    : [","],
            "type"          : "correlation"
            },
            {
            ...
            "paths"         : [r"C:\Programming\Translational_genomics\NMD_analysis\random_forest\teran_lindeboom\forest_importances.txt"],
            "separators"    : [","],
            ...
            "paths"         : [r"C:\Programming\Translational_genomics\NMD_analysis\random_forest\teran_lindeboom\single_unbalanced\all_preds.txt"],
            "separators"    : [","],
            "type"          : "correlation"
            },
            {
            ...
            "paths"         : [r"C:\Programming\Translational_genomics\NMD_analysis\random_forest\teran_lindeboom\balanced"],
            "separators"    : [","],
            "type"          : "auroc"
            },
            {
            ...
            },
            {
             ...
             "off"           : True,
             "paths"         : [r"C:\Programming\Translational_genomics\NMD_analysis\data\control_filtered_appended.txt"],
             "separators"    : [","],
             "type"          : "correlation2"
            },
        ]
    ...
    dims           = [4, 4]
    resolution     = 600
    run_dir        = r"C:\Programming\Translational_genomics\NMD_analysis\draft"
    ...
    for i in range(len(data)):
        ...
        if data[i]["type"] == "box_plot" or data[i]["type"] == "correlation2":
            # data filtering
            ...
            #data[i]["data"][0] = data[i]["data"][0][data[i]["data"][0]["LABEL:NMD score"] > data[i]["filter"]["label_outlier"]]
